...
const pickForHer = () => {
  ...
  return (
    <div className="px-7 mt-5 md:px-10 lg:px-30 xl:px-30 2xl:px-30 ">
      {/* Header */}
      <div className="flex items-center justify-between mb-3 mt-3 relative">
        <div className="flex items-center">
          <h2 className="font-[poppins] text-lg font-semibold">Pick For Her</h2>
          <CircleHelp
            size={20}
        ...
        {popover && (
          ...
          >
            <p>
              These handpicked items are perfect for making her day extra
              special.
            </p>
          </div>
        )}
