...
const Categori = () => {
    return (
        <>
        {/* categori */}
           <div className="sticky top-0 z-50 overflow-x-auto">
  <div className="flex font-[poppins] font-semibold gap-7 items-center justify-center 
    ...
    {["Brands", "New", "Men", "Woman", "Kids", "Sneaker", "Shoes", "Apparel", "Accessories"].map((item) => (
